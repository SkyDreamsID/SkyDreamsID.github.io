...
export function QuoteCard({ data, isLoading }: { data?: any, isLoading?: boolean }) {
  ...
  return (
    <motion.a
      href="https://discordapp.com/users/17854" // Assuming 17854 is the discord related text from previous chat (or we can just put https://discord.com)
      target="_blank"
      rel="noreferrer"
      whileHover={{ y: -4 }}
    ...
    >
      ...
      <div className="relative z-10">
        <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#5865F2] text-white">
          <svg
